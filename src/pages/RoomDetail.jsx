...
const CarIcon = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 16.5 17.5 13H22v-2h-4.5l-3.5 3.5"></path><path d="m5.5 16.5-3-3H1v2h1.5l3 3"></path><path d="M3 10h18v6H3z"></path><path d="m12 10-1.5-8-5 8"></path><path d="m12 10 1.5-8 5 8"></path></svg>;
...
const ShowerIcon = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m4 4 2.5 2.5"></path><path d="M13.5 6.5a4.5 4.5 0 0 0-6.364 6.364"></path><path d="m20 12-1.5 1.5"></path><path d="M14 17.5a4.5 4.5 0 0 0 6.364-6.364"></path><path d="M12 22v-4"></path><path d="M9 16H3"></path><path d="M16 9v6"></path></svg>;
...
const ChevronRightIcon = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m9 18 6-6-6-6"></path></svg>;
